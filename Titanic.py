# -*- coding: utf-8 -*-
"""
Created on Wed Jun 01 21:32:26 2016

@author: daphne.yw.lee
"""
...
csv_file_object = csv.reader(open('C:/Daphne/train.csv', 'rb')) 
...
test_file = open('C:/Daphne/test.csv', 'rb')
...
for i in xrange(number_of_classes):       #loop through each class
  for j in xrange(number_of_price_brackets):   #loop through each price bin
    ...
    test_file_object = csv.reader(test_file)
    header = test_file_object.next()
    predictions_file = open("C:/Daphne/genderclassmodel.csv", "wb")
